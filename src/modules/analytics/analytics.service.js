...
import { calculateTransitionInsights } from '../../utils/calculateTransition.js'
    ...
    static async generateFullReportPDF({ startDate, endDate } = {}) {
        try {
            const [
                ...
                this.getReportsByStatus({ startDate, endDate }),
                this.getReportsByCategory({ startDate, endDate }),
                this.getReportsOverTime({ period: 'week', startDate, endDate }),
                this.getReportResolutionTime({ startDate, endDate }),
                this.getTimeByStatus({ startDate, endDate }),
                this.getStatusTransitions({ startDate, endDate })
            ])
